...
import { suggestionSchema, SuggestionFormData, extractYouTubeId, getYouTubeThumbnail, getYouTubeStats } from '@/lib/schemas';
import React, { useEffect, useState } from 'react';
import { Music, Info, Eye, ThumbsUp, AlertCircle } from 'lucide-react';
        ...
        if (youtubeUrl) {
            ...
            if (videoId) {
                ...
                const fetchTitle = async () => {
                    const { title, viewCount, likeCount } = await getYouTubeStats(videoId)
